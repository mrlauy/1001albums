...
class AboutPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(children: <Widget>[
        ...
        _buildVersion(context, 'v1.0.1'),
        _buildDescription(context, Theme.of(context).textTheme.bodyText1,
        ...
        _buildDescription(context, Theme.of(context).textTheme.bodyText2,
  ...
  Widget _buildVersion(BuildContext context, String version) {
    return Container(
      padding: EdgeInsets.all(16.0),
      child: Center(
        child: Text(version, style: Theme.of(context).textTheme.caption),
      ),
    );
  }
  ...
  Widget _buildFooter(BuildContext context, String footer) {
    return Container(
      padding: EdgeInsets.all(16.0),
      child: Center(
          child: Text(footer, style: Theme.of(context).textTheme.caption)),
    );
  }
}
